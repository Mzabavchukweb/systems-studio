...
(function () {
    ...
    const translations = {
        ...
        pl: {
            ...
            'spokoju.subtitle': 'Domowy standard organizacji w sytuacjach zakłóceń',
            'spokoju.intro': 'System Spokoju™ to prosty zestaw checklist i kart offline, który pomaga zachować porządek, jasne decyzje i spokój w pierwszych minutach nieprzewidzianych sytuacji.',
            'spokoju.feat1': 'Bez aplikacji.',
            'spokoju.feat2': 'Bez chaosu.',
            'spokoju.feat3': 'Bez improwizacji.',
            'spokoju.why_title': 'Dlaczego ludzie tego potrzebują',
            'spokoju.why_lead': 'W stresie problemem nie jest zdarzenie — tylko brak planu:',
            'spokoju.why1': 'kto co robi',
            'spokoju.why2': 'co jest priorytetem',
            'spokoju.why3': 'co zabrać',
            'spokoju.why4': 'jak uniknąć chaosu',
            'spokoju.why_closing': 'System daje gotowy schemat działania zamiast nerwowych decyzji.',
            'spokoju.benefits_title': 'Co daje w praktyce',
            'spokoju.benefit1': 'mniej paniki i konfliktów',
            'spokoju.benefit2': 'szybkie uporządkowanie sytuacji',
            'spokoju.benefit3': 'kontrolę nad rzeczami i dokumentami',
            'spokoju.benefit4': 'jasne role domowe',
            'spokoju.benefits_closing': 'Sprawdza się przy awariach, blackoutach, nagłych wyjazdach i innych zakłóceniach dnia.',
            'spokoju.variants_title': 'Warianty',
            'spokoju.home_desc': 'Dla domów i mieszkań bez zwierząt.',
            'spokoju.pets_desc': 'Pełna wersja z modułem zwierząt (opieka, transport, checklisty).',
            'spokoju.delivery': 'Digital Pack (PL + ENG) • Instant download',
        ...
        en: {
            ...
            'spokoju.subtitle': 'Home organization standard for disruption situations',
            'spokoju.intro': 'Peace of Mind System™ is a simple set of offline checklists and cards that helps maintain order, clear decisions, and calm in the first minutes of unexpected situations.',
            'spokoju.feat1': 'No apps.',
            'spokoju.feat2': 'No chaos.',
            'spokoju.feat3': 'No improvisation.',
            'spokoju.why_title': 'Why people need this',
            'spokoju.why_lead': 'Under stress, the problem isn\'t the event — it\'s the lack of a plan:',
            'spokoju.why1': 'who does what',
            'spokoju.why2': 'what\'s the priority',
            'spokoju.why3': 'what to take',
            'spokoju.why4': 'how to avoid chaos',
            'spokoju.why_closing': 'The system provides a ready-made action plan instead of nervous decisions.',
            'spokoju.benefits_title': 'What it delivers',
            'spokoju.benefit1': 'less panic and conflict',
            'spokoju.benefit2': 'quick situation control',
            'spokoju.benefit3': 'control over belongings and documents',
            'spokoju.benefit4': 'clear household roles',
            'spokoju.benefits_closing': 'Works for breakdowns, blackouts, emergency trips, and other daily disruptions.',
            'spokoju.variants_title': 'Variants',
            'spokoju.home_desc': 'For homes and apartments without pets.',
            'spokoju.pets_desc': 'Full version with pet module (care, transport, checklists).',
            'spokoju.delivery': 'Digital Pack (PL + ENG) • Instant download',
        ...
        nl: {
            ...
            'spokoju.subtitle': 'Thuisstandaard voor organisatie bij verstoringen',
            'spokoju.intro': 'Rust Systeem™ is een eenvoudige set offline checklists en kaarten die helpt bij het bewaren van orde, heldere beslissingen en rust in de eerste minuten van onverwachte situaties.',
            'spokoju.feat1': 'Geen apps.',
            'spokoju.feat2': 'Geen chaos.',
            'spokoju.feat3': 'Geen improvisatie.',
            'spokoju.why_title': 'Waarom mensen dit nodig hebben',
            'spokoju.why_lead': 'Bij stress is het probleem niet de gebeurtenis — maar het ontbreken van een plan:',
            'spokoju.why1': 'wie doet wat',
            'spokoju.why2': 'wat heeft prioriteit',
            'spokoju.why3': 'wat mee te nemen',
            'spokoju.why4': 'hoe chaos te voorkomen',
            'spokoju.why_closing': 'Het systeem biedt een kant-en-klaar actieplan in plaats van nerveuze beslissingen.',
            'spokoju.benefits_title': 'Wat het oplevert',
            'spokoju.benefit1': 'minder paniek en conflicten',
            'spokoju.benefit2': 'snelle controle over de situatie',
            'spokoju.benefit3': 'controle over bezittingen en documenten',
            'spokoju.benefit4': 'duidelijke huishoudelijke rollen',
            'spokoju.benefits_closing': 'Werkt bij storingen, stroomuitval, noodreizen en andere dagelijkse verstoringen.',
            'spokoju.variants_title': 'Varianten',
            'spokoju.home_desc': 'Voor woningen zonder huisdieren.',
            'spokoju.pets_desc': 'Volledige versie met huisdiermodule (verzorging, vervoer, checklists).',
            'spokoju.delivery': 'Digital Pack (PL + ENG) • Instant download',
